...
namespace Expense_Tracker.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentBudget = table.Column<decimal>(
                        type: "numeric(18,2)",
                        precision: 18,
                        scale: 2,
                        nullable: false
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalIssuedAt = table.Column<DateTimeOffset>(
                        type: "timestamptz",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceToken = table.Column<string>(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_SessionFamilyId_DeviceId",
                table: "RefreshTokens",
                columns: new[] { "SessionFamilyId", "DeviceId" }
            );
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "FamilyBudgetHistories");

            migrationBuilder.DropTable(name: "FamilyUsers");
